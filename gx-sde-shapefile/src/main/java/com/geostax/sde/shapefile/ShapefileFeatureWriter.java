...
import com.geostax.sde.shapefile.dbf.DbaseFileHeader;
import com.geostax.sde.shapefile.dbf.DbaseFileWriter;
...
import com.geostax.sde.shapefile.shp.JTSUtilities;
import com.geostax.sde.shapefile.shp.ShapeHandler;
import com.geostax.sde.shapefile.shp.ShapeType;
import com.geostax.sde.shapefile.shp.ShapefileException;
import com.geostax.sde.shapefile.shp.ShapefileWriter;
        ...
        if (guessShapeType) {
            try {
                if (g != null) {
                    ...
                    shapeType = JTSUtilities.getShapeType(currentFeature.getType()
